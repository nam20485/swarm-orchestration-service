...
- **Top level — still open.** A doc here is awaiting implementation or an owner
  ...
  - [`fold-workflow-launch2-into-service.md`](fold-workflow-launch2-into-service.md) — PR #20
    open against `development`, CI green, merge owner-gated; minimal-closure fold of
    the `nam20485/workflow-launch2` launcher pipeline into this repo. The
    `workflow-launch2` teardown is plan-only — that repo is not touched by this change.
